    ...
    <div className="flex flex-col border border-neutral-200 rounded-2xl overflow-hidden bg-white">
      ...
      {data.map((parent: any, i: number) => {
        ...
        return (
          <div
          onClick={()=>{
            router.push("/admin/parents/123")
          }}
            key={parent.registration_no}
            className={`grid cursor-pointer grid-cols-2 md:grid-cols-[2fr_1.6fr_1fr_1fr_0.8fr_0.9fr_auto] gap-3 items-center px-4 py-4.5  text-sm ${
